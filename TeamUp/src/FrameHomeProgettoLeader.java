...
public class FrameHomeProgettoLeader {
	...
	private JButton bottoneModificaProgetto;
	private JButton bottoneEliminaProgetto;
	private JButton bottoneGestioneRichieste;
	...
	public FrameHomeProgettoLeader() {
			
		
		
		frame = new JFrame("Home Progetto Leader");
	    ...
	    labelDataCreazioneVuoto.setBounds(255, 76, 250, 150);
	    ...
	    labelCategoriaVuoto.setBounds(256, 161, 200, 150);
	    ...
	    labelRicercaCompetenzeVuoto = new JLabel("Ricerca Competenza vuoto");
	    ...
	    textDescrizioneVuoto.setBounds(256, 268, 333, 69);
		...
		bottoneModificaProgetto = new JButton("Modifica Progetto");
		bottoneModificaProgetto.setForeground(Color.BLACK);
		bottoneModificaProgetto.setFont(new Font("Tahoma", Font.BOLD, 20));
		bottoneModificaProgetto.setBounds(241, 500, 200, 40);
		bottoneModificaProgetto.setFocusable(false);
		bottoneModificaProgetto.setBorder(new BevelBorder(BevelBorder.LOWERED,null,null,null,null));
		frame.getContentPane().add(bottoneModificaProgetto);
	    
		
		bottoneGestioneRichieste = new JButton("Gestione Richieste");
		bottoneGestioneRichieste.setForeground(Color.BLACK);
		bottoneGestioneRichieste.setFont(new Font("Tahoma", Font.BOLD, 20));
		bottoneGestioneRichieste.setBounds(35, 500, 198, 40);
		bottoneGestioneRichieste.setFocusable(false);
		bottoneGestioneRichieste.setBorder(new BevelBorder(BevelBorder.LOWERED,null,null,null,null));
		frame.getContentPane().add(bottoneGestioneRichieste);
	    
		
		bottoneEliminaProgetto = new JButton("Elimina Progetto");
		bottoneEliminaProgetto.setForeground(Color.BLACK);
		bottoneEliminaProgetto.setFont(new Font("Tahoma", Font.BOLD, 20));
		bottoneEliminaProgetto.setBounds(447, 500, 176, 40);
		bottoneEliminaProgetto.setFocusable(false);
		bottoneEliminaProgetto.setBorder(new BevelBorder(BevelBorder.LOWERED,null,null,null,null));
		frame.getContentPane().add(bottoneEliminaProgetto);
	...
	public void setLabelDataCreazioneVuoto(String  labelDataCreazione) {
		this.labelDataCreazioneVuoto.setText(labelDataCreazione);
	}
	...
	public void setLabelCategoria(String labelCategoria) {
		this.labelCategoria.setText(labelCategoria);
	}
	...
	public JButton getBottoneModificaProgetto() {
		return bottoneModificaProgetto;
	}
	...
	public void setBottoneModificaProgetto(JButton bottoneModificaProgetto) {
		this.bottoneModificaProgetto = bottoneModificaProgetto;
	}
	...
	public JButton getBottoneEliminaProgetto() {
		return bottoneEliminaProgetto;
	}
	...
	public void setBottoneEliminaProgetto(JButton bottoneEliminaProgetto) {
		this.bottoneEliminaProgetto = bottoneEliminaProgetto;
	}
	...
	public JButton getBottoneGestioneRichieste() {
		return bottoneGestioneRichieste;
	}
	...
	public void setBottoneGestioneRichieste(JButton bottoneGestioneRichieste) {
		this.bottoneGestioneRichieste = bottoneGestioneRichieste;
	}
